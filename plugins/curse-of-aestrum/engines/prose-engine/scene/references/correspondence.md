...
[../narration_modes.md]({{PLUGIN_ROOT}}/engines/prose-engine/scene/narration_modes.md)). Governs the **form** of
...
[../registers.md]({{PLUGIN_ROOT}}/engines/prose-engine/scene/registers.md)), which may differ from how they
