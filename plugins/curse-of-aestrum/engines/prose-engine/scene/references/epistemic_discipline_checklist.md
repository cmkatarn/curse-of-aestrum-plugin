...
| 11 | **Cross-scene-conversation** | Anaphoric or shared-past constructions (*as we discussed, what we agreed, our conversation, like I told you, as I said, you said, you told me, remember when we, remember you said, our agreement, the plan we made*) | Speaker A invokes a prior conversation with addressee B (or with a third party C in B's hearing) that is not recorded in A's perception log or scene log A could cite. **Same-scene exception — it grounds the *participants*, never the *utterance*.** A conversation earlier in the **current** scene is grounded only if that exchange is actually *on the page* (rendered in a prior beat, or recorded in this scene's staged/saved record). Co-presence through a long scene grounds **nothing** by itself: "we have both been in this room all evening" is not evidence that A ever said the thing B now quotes. **This is the exception's failure direction and the likelier one in a long scene** — the drafter, holding hours of busy shared context, reaches for a plausible exchange that never occurred and the blanket exception waves it through. A *near-miss* is the canonical shape: the real interaction was adjacent but different in kind (Alice **overruled** Bob's suggestion; Bob later reports that Alice **asked him whether he was sure**) | New-information register (introduce point fresh); surface as A's own prior intention (*"I had been meaning to ask"*); or drop the anaphoric clause | Scene-log search for A's participation history (skip if already in working memory) |
